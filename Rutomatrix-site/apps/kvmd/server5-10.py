...
#                i2c_module.select_mux_channel(1)
#                i2c_module.execute_i2cset(0x24, 0x00, 0x3f)
#               i2c_module.execute_i2cset(0x24, 0x0c, 0xff)

#                input_status_hex = i2c_module.execute_i2cget(0x24, 0x12)
 #               input_status_bin = bin(int(input_status_hex, 16))[2:].zfill(8)
  #              logger.info("Executing i2c_module")
   #             logger.info("Input Status (Binary):", input_status_bin)
    #            logger.info("Input Status (Hexadecimal):", input_status_hex)
#
 #               i2c_module.execute_i2cset(0x24, 0x12, 0x00)
