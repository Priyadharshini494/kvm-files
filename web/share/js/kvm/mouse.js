...
export function Mouse2(__getGeometry, __recordWsEvent) {
	var self = this;
	...
	var __init__ = function() {
		...
		document.onpointerlockchange = __relativeCapturedHandler; // Only for relative
		document.onpointerlockerror = __relativeCapturedHandler;
		$("stream-box2").onmouseenter = () => __streamHoveredHandler(true);
		$("stream-box2").onmouseleave = () => __streamHoveredHandler(false);
		$("stream-box2").onmousedown = (event) => __streamButtonHandler(event, true);
		$("stream-box2").onmouseup = (event) => __streamButtonHandler(event, false);
		$("stream-box2").oncontextmenu = (event) => event.preventDefault();
		$("stream-box2").onmousemove = __streamMoveHandler;
		$("stream-box2").onwheel = __streamScrollHandler;
		$("stream-box2").ontouchstart = (event) => __streamTouchStartHandler(event);
		$("stream-box2").ontouchmove = (event) => __streamTouchMoveHandler(event);
		$("stream-box2").ontouchend = (event) => __streamTouchEndHandler(event);
	...
	self.setSocket = function(ws) {
		__ws = ws;
		$("stream-box2").classList.toggle("stream-box-mouse-enabled", ws);
		if (!__absolute && __isRelativeCaptured()) {
			document.exitPointerLock();
		}
		__updateOnlineLeds();
	...
	var __streamButtonHandler = function(event, state) {
		...
		if (__absolute || __isRelativeCaptured()) {
			...
			$("stream-box2").requestPointerLock();
		}
	};
...
export function Mouse3(__getGeometry, __recordWsEvent) {
	var self = this;
	...
	var __init__ = function() {
		...
		document.onpointerlockchange = __relativeCapturedHandler; // Only for relative
		document.onpointerlockerror = __relativeCapturedHandler;
		$("stream-box3").onmouseenter = () => __streamHoveredHandler(true);
		$("stream-box3").onmouseleave = () => __streamHoveredHandler(false);
		$("stream-box3").onmousedown = (event) => __streamButtonHandler(event, true);
		$("stream-box3").onmouseup = (event) => __streamButtonHandler(event, false);
		$("stream-box3").oncontextmenu = (event) => event.preventDefault();
		$("stream-box3").onmousemove = __streamMoveHandler;
		$("stream-box3").onwheel = __streamScrollHandler;
		$("stream-box3").ontouchstart = (event) => __streamTouchStartHandler(event);
		$("stream-box3").ontouchmove = (event) => __streamTouchMoveHandler(event);
		$("stream-box3").ontouchend = (event) => __streamTouchEndHandler(event);
	...
	self.setSocket = function(ws) {
		__ws = ws;
		$("stream-box3").classList.toggle("stream-box-mouse-enabled", ws);
		if (!__absolute && __isRelativeCaptured()) {
			document.exitPointerLock();
		}
		__updateOnlineLeds();
	...
	var __streamButtonHandler = function(event, state) {
		...
		if (__absolute || __isRelativeCaptured()) {
			...
			$("stream-box3").requestPointerLock();
		}
	};
...
export function Mouse4(__getGeometry, __recordWsEvent) {
	var self = this;
	...
	var __init__ = function() {
		...
		document.onpointerlockchange = __relativeCapturedHandler; // Only for relative
		document.onpointerlockerror = __relativeCapturedHandler;
		$("stream-box4").onmouseenter = () => __streamHoveredHandler(true);
		$("stream-box4").onmouseleave = () => __streamHoveredHandler(false);
		$("stream-box4").onmousedown = (event) => __streamButtonHandler(event, true);
		$("stream-box4").onmouseup = (event) => __streamButtonHandler(event, false);
		$("stream-box4").oncontextmenu = (event) => event.preventDefault();
		$("stream-box4").onmousemove = __streamMoveHandler;
		$("stream-box4").onwheel = __streamScrollHandler;
		$("stream-box4").ontouchstart = (event) => __streamTouchStartHandler(event);
		$("stream-box4").ontouchmove = (event) => __streamTouchMoveHandler(event);
		$("stream-box4").ontouchend = (event) => __streamTouchEndHandler(event);
	...
	self.setSocket = function(ws) {
		__ws = ws;
		$("stream-box4").classList.toggle("stream-box-mouse-enabled", ws);
		if (!__absolute && __isRelativeCaptured()) {
			document.exitPointerLock();
		}
		__updateOnlineLeds();
	...
	var __streamButtonHandler = function(event, state) {
		...
		if (__absolute || __isRelativeCaptured()) {
			...
			$("stream-box4").requestPointerLock();
		}
	};
