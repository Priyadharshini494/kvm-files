...
export function Hid2(__getGeometry, __recorder) {
	var self = this;
...
export function Hid3(__getGeometry, __recorder) {
	var self = this;
...
export function Hid4(__getGeometry, __recorder) {
	var self = this;
