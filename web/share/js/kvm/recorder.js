...
export function Recorder2() {
	...
	var __init__ = function() {
		tools.el.setOnClick($("hid-recorder-record2"), __startRecord);
		tools.el.setOnClick($("hid-recorder-stop2"), __stopProcess);
		tools.el.setOnClick($("hid-recorder-play2"), __playRecord);
		tools.el.setOnClick($("hid-recorder-clear2"), __clearRecord);

		$("hid-recorder-new-script-file2").onchange = __uploadScript;
		tools.el.setOnClick($("hid-recorder-upload2"), () => $("hid-recorder-new-script-file2").click());
		tools.el.setOnClick($("hid-recorder-download2"), __downloadScript);
	};
	...
	var __uploadScript = function() {
		let el_input = $("hid-recorder-new-script-file2");
		let script_file = (el_input.files.length ? el_input.files[0] : null);
		if (script_file) {
			let reader = new FileReader();
			reader.onload = function () {
	...
	var __runEvents = function(index, time=0) {
		...
		if ($("hid-recorder-loop-switch2").checked) {
			setTimeout(() => __runEvents(0));
		} else {
			__stopProcess();
		}
	...
	var __refresh = function() {
		if (__play_timer) {
			$("hid-recorder-led2").className = "led-yellow-rotating-fast";
			$("hid-recorder-led2").title = "Playing...";
		} else if (__recording) {
			$("hid-recorder-led2").className = "led-red-rotating-fast";
			$("hid-recorder-led2").title = "Recording...";
		} else {
			$("hid-recorder-led2").className = "led-gray";
			$("hid-recorder-led2").title = "";
		}

		tools.el.setEnabled($("hid-recorder-record2"), (__ws && !__play_timer && !__recording));
		tools.el.setEnabled($("hid-recorder-stop2"), (__ws && (__play_timer || __recording)));
		tools.el.setEnabled($("hid-recorder-play2"), (__ws && !__recording && __events.length));
		tools.el.setEnabled($("hid-recorder-clear2"), (!__play_timer && !__recording && __events.length));
		tools.el.setEnabled($("hid-recorder-loop-switch2"), (__ws && !__recording));

		tools.el.setEnabled($("hid-recorder-upload2"), (!__play_timer && !__recording));
		tools.el.setEnabled($("hid-recorder-download2"), (!__play_timer && !__recording && __events.length));

		__setCounters(__events.length, __events_time);
	};

	var __setCounters = function(events_count, events_time) {
		$("hid-recorder-time2").innerHTML = tools.formatDuration(events_time);
		$("hid-recorder-events-count2").innerHTML = events_count;
	};

	__init__();
}

export function Recorder4() {
	var self = this;
	...
	var __init__ = function() {
		tools.el.setOnClick($("hid-recorder-record4"), __startRecord);
		tools.el.setOnClick($("hid-recorder-stop4"), __stopProcess);
		tools.el.setOnClick($("hid-recorder-play4"), __playRecord);
		tools.el.setOnClick($("hid-recorder-clear4"), __clearRecord);

		$("hid-recorder-new-script-file4").onchange = __uploadScript;
		tools.el.setOnClick($("hid-recorder-upload4"), () => $("hid-recorder-new-script-file4").click());
		tools.el.setOnClick($("hid-recorder-download4"), __downloadScript);
	};
	...
	var __uploadScript = function() {
		let el_input = $("hid-recorder-new-script-file4");
		let script_file = (el_input.files.length ? el_input.files[0] : null);
		if (script_file) {
			let reader = new FileReader();
			reader.onload = function () {
	...
	var __runEvents = function(index, time=0) {
		...
		if ($("hid-recorder-loop-switch4").checked) {
			setTimeout(() => __runEvents(0));
		} else {
			__stopProcess();
		}
	...
	var __refresh = function() {
		if (__play_timer) {
			$("hid-recorder-led4").className = "led-yellow-rotating-fast";
			$("hid-recorder-led4").title = "Playing...";
		} else if (__recording) {
			$("hid-recorder-led4").className = "led-red-rotating-fast";
			$("hid-recorder-led4").title = "Recording...";
		} else {
			$("hid-recorder-led4").className = "led-gray";
			$("hid-recorder-led4").title = "";
		}

		tools.el.setEnabled($("hid-recorder-record4"), (__ws && !__play_timer && !__recording));
		tools.el.setEnabled($("hid-recorder-stop4"), (__ws && (__play_timer || __recording)));
		tools.el.setEnabled($("hid-recorder-play4"), (__ws && !__recording && __events.length));
		tools.el.setEnabled($("hid-recorder-clear4"), (!__play_timer && !__recording && __events.length));
		tools.el.setEnabled($("hid-recorder-loop-switch4"), (__ws && !__recording));

		tools.el.setEnabled($("hid-recorder-upload4"), (!__play_timer && !__recording));
		tools.el.setEnabled($("hid-recorder-download4"), (!__play_timer && !__recording && __events.length));

		__setCounters(__events.length, __events_time);
	};

	var __setCounters = function(events_count, events_time) {
		$("hid-recorder-time4").innerHTML = tools.formatDuration(events_time);
		$("hid-recorder-events-count4").innerHTML = events_count;
	};
