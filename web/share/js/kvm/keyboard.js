...
export function Keyboard2(__recordWsEvent) {
	var self = this;
	...
	var __init__ = function() {
		...
		$("hid-keyboard-led2").title = "Keyboard free";
		...
		$("stream-window2").onkeydown = (event) => __keyboardHandler(event, true);
		$("stream-window2").onkeyup = (event) => __keyboardHandler(event, false);
		$("stream-window2").onfocus = __updateOnlineLeds;
		$("stream-window2").onblur = __updateOnlineLeds;
	...
	var __updateOnlineLeds = function() {
		let is_captured = (
			$("stream-window2").classList.contains("window-active")
			|| $("keyboard-window").classList.contains("window-active")
		);
		let led = "led-gray";
		let title = "Keyboard free";
...
export function Keyboard3(__recordWsEvent) {
	var self = this;
	...
	var __init__ = function() {
		...
		$("hid-keyboard-led3").title = "Keyboard free";
		...
		$("stream-window3").onkeydown = (event) => __keyboardHandler(event, true);
		$("stream-window3").onkeyup = (event) => __keyboardHandler(event, false);
		$("stream-window3").onfocus = __updateOnlineLeds;
		$("stream-window3").onblur = __updateOnlineLeds;
	...
	var __updateOnlineLeds = function() {
		let is_captured = (
			$("stream-window3").classList.contains("window-active")
			|| $("keyboard-window").classList.contains("window-active")
		);
		let led = "led-gray";
		let title = "Keyboard free";
...
export function Keyboard4(__recordWsEvent) {
	var self = this;
	...
	var __init__ = function() {
		...
		$("hid-keyboard-led4").title = "Keyboard free";
		...
		$("stream-window4").onkeydown = (event) => __keyboardHandler(event, true);
		$("stream-window4").onkeyup = (event) => __keyboardHandler(event, false);
		$("stream-window4").onfocus = __updateOnlineLeds;
		$("stream-window4").onblur = __updateOnlineLeds;
	...
	var __updateOnlineLeds = function() {
		let is_captured = (
			$("stream-window4").classList.contains("window-active")
			|| $("keyboard-window").classList.contains("window-active")
		);
		let led = "led-gray";
		let title = "Keyboard free";
