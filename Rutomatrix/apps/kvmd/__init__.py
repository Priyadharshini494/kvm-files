<<<<<<<< HEAD:rutomatrix/apps/rutomatrix/__init__.py
========
# ========================================================================== #
#                                                                            #
...
>>>>>>>> 0310e6c9cbc11bd4d26a951acd967fe40ac8a256:Rutomatrix/apps/kvmd/__init__.py
...
from .ocr import Ocr
<<<<<<<< HEAD:rutomatrix/apps/rutomatrix/__init__.py
from .server import RutomatrixServer
========
...
<<<<<<<< HEAD:rutomatrix/apps/rutomatrix/__init__.py
    msd_kwargs = config.rutomatrix.msd._unpack(ignore=["type"])
    if config.rutomatrix.msd.type == "otg":
        msd_kwargs["gadget"] = config.otg.gadget  # XXX: Small crutch to pass gadget name to the plugin

    hid_kwargs = config.rutomatrix.hid._unpack(ignore=["type", "keymap", "ignore_keys", "mouse_x_range", "mouse_y_range"])
    if config.rutomatrix.hid.type == "otg":
        hid_kwargs["udc"] = config.otg.udc  # XXX: Small crutch to pass UDC to the plugin

    global_config = config
    config = config.rutomatrix
========
